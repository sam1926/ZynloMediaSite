  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      if (!isMobile) {
        ...
        gsap.from(
          ".service-card",
          createScrollTrigger(".service-card", {
            ...animations.fadeInUp,
            y: 60,
            stagger: 0.2,
          }),
        ...
        gsap.from(
          ".portfolio-item",
          createScrollTrigger(".portfolio-item", {
            ...animations.scaleIn,
            stagger: 0.15,
          }),
        );
        ...
        gsap.from(
          ".about-image",
          createScrollTrigger(".about-image", animations.slideInLeft),
        );
        gsap.from(
          ".about-content",
          createScrollTrigger(".about-content", animations.slideInRight),
        );

        // Testimonial cards
        gsap.from(
          ".testimonial-card",
          createScrollTrigger(".testimonial-card", {
            ...animations.fadeInUp,
            y: 80,
            stagger: 0.3,
          }),
        ...
        gsap.from(
          ".contact-info",
          createScrollTrigger(".contact-info", animations.slideInLeft),
        );
        gsap.from(
          ".contact-form",
          createScrollTrigger(".contact-form", animations.slideInRight),
        );
